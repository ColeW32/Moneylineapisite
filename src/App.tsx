        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 sm:pt-4 pb-10 sm:pb-12 lg:pb-16">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-start">
            ...
            <div className="pt-0 sm:pt-1 min-w-0">
              ...
              <div className="mt-2 pt-2 overflow-x-auto pb-2 scroll-smooth snap-x snap-mandatory [scrollbar-width:thin]" style={{ scrollPaddingLeft: "20px" }}>
                <div className="flex gap-3 min-w-max items-stretch pl-8 pr-6 sm:pl-4 sm:pr-6">
                  {API_ENDPOINTS.map((ep, i) => (
                    <button
                      key={i}
                      type="button"
                      onClick={() => setHeroEndpointIndex(i)}
                      className={`flex-shrink-0 w-[152px] sm:w-[160px] snap-start rounded-lg border px-3 pt-3 pb-2.5 text-left transition-colors cursor-pointer ${i === 0 ? "ml-3 sm:ml-0" : ""} ${
                        heroEndpointIndex === i
